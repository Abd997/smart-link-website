...
export default function AdminDashboard() {
  ...
  const fetchLinks = async () => {
    try {
      ...
      const message = error instanceof Error ? error.message : "Error fetching links"
  ...
  const handleAddOrChange = async () => {
    ...
    try {
      ...
      const message =
        error instanceof Error ? error.message : "Error adding or changing link"
  ...
  const handleRemove = async (id: number) => {
    try {
      ...
      const message = error instanceof Error ? error.message : "Error removing link"
      setError(message)
    }
  }
  ...
  const handleAskAI = async () => {
    ...
    try {
      ...
      const message =
        error instanceof Error ? error.message : "Error generating AI description"
      setError(message)
    } finally {
      setAiLoading(false)
    }
